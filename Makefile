...
SRC = src/minishell.c src/lexer_utils.c src/system_utils.c src/string_utils.c src/token_handlers.c src/free_utils.c src/command_handler.c src/cd_utils.c
OBJ = obj
NAME = minishell
